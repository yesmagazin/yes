...
<div id="content">
      ...
      <div class="panel-body">
		...
		<div class="form-group">
			...
			<option value="" disabled>Выберите город</option>
			   ...
			   <option value="<?php echo $category['category_id']; ?>" <?php if(isset($eventcategoryids)){  foreach($eventcategoryids as $ids){ if($ids['category_id']==$category['category_id']) echo "selected"; } } ?>><?php echo $category['category_name']; ?></option>
  ...
  <table class="table">
		...
		<td><a href="index.php?route=extension/module/events&event_id=<?php echo $list['event_id']; ?>&token=<?php echo $token; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> <a href="index.php?route=extension/module/events/delete&event_id=<?php echo $list['event_id']; ?>&token=<?php echo $token; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
		</tr>
