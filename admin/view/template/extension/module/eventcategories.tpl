    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
		...
		<div class="form-group">
            <label class="col-sm-2 control-label" for="input-status">Наиминование </label>
            <div class="col-sm-10">
  ...
  <table class="table">
    ...
    <th>
      Наминование магазина
		...
		<td><a href="index.php?route=extension/module/eventcategories&category_id=<?php echo $list['category_id']; ?>&token=<?php echo $token; ?>" class="btn btn-primary"><i class="fa fa-pencil"></i></a> <a href="index.php?route=extension/module/eventcategories/delete&category_id=<?php echo $list['category_id']; ?>&token=<?php echo $token; ?>" class="btn btn-danger"><i class="fa fa-trash-o"></i></a></td>
		</tr>
