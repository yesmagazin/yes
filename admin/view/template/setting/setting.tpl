          ...
          <div class="tab-content">
              ...
              <div class="tab-content">
                ...
                <div class="tab-pane" id="content-language<?php echo $language['language_id']; ?>">
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-sm-10">
                      <input name="config_langdata[<?php echo $language['language_id']; ?>][meta_description]" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_description'] : ''; ?>" placeholder="<?php echo $entry_meta_description; ?>" id="input-meta-description<?php echo $language['language_id']; ?>" class="form-control">
                    </div>
                  </div>
                  <div class="form-group">
                    <label class="col-sm-2 control-label" for="input-meta-keyword<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword; ?></label>
                    <div class="col-sm-10">
                      <input name="config_langdata[<?php echo $language['language_id']; ?>][meta_keyword]" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_keyword'] : ''; ?>" placeholder="<?php echo $entry_meta_keyword; ?>" id="input-meta-keyword<?php echo $language['language_id']; ?>" class="form-control" />
                    </div>
                  </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-title-cat[<?php echo $language['language_id']; ?>]"><?php echo $entry_meta_title_cat; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_title_cat]" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_title_cat'] : ''; ?>" placeholder="<?php echo $entry_meta_title_cat; ?>" id="input-meta-title-cat[<?php echo $language['language_id']; ?>]" class="form-control" />
                            <?php if (isset($error_meta_title_cat[$language['language_id']])) { ?>
                            <div class="text-danger"><?php echo $error_meta_title_cat[$language['language_id']]; ?></div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-description-cat<?php echo $language['language_id']; ?>"><?php echo $entry_meta_description_cat; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_description_cat]" placeholder="<?php echo $entry_meta_description_cat; ?>" id="input-meta-description-cat<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_description_cat'] : ''; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-keyword-cat<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword_cat; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_keyword_cat]" placeholder="<?php echo $entry_meta_keyword_cat; ?>" id="input-meta-keyword-cat<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_keyword_cat'] : ''; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-title-prod[<?php echo $language['language_id']; ?>]"><?php echo $entry_meta_title_prod; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_title_prod]" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_title_prod'] : ''; ?>" placeholder="<?php echo $entry_meta_title_prod; ?>" id="input-meta-title-prod[<?php echo $language['language_id']; ?>]" class="form-control" />
                            <?php if (isset($error_meta_title_prod[$language['language_id']])) { ?>
                            <div class="text-danger"><?php echo $error_meta_title_prod[$language['language_id']]; ?></div>
                            <?php } ?>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-description-prod<?php echo $language['language_id']; ?>"><?php echo $entry_meta_description_prod; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_description_prod]" placeholder="<?php echo $entry_meta_description_prod; ?>" id="input-meta-description-prod<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_description_prod'] : ''; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-meta-keyword-prod<?php echo $language['language_id']; ?>"><?php echo $entry_meta_keyword_prod; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][meta_keyword_prod]" placeholder="<?php echo $entry_meta_keyword_prod; ?>" id="input-meta-keyword-prod<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['meta_keyword_prod'] : ''; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-po-cene<?php echo $language['language_id']; ?>"><?php echo $entry_po_cene; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][po_cene]" placeholder="<?php echo $entry_po_cene; ?>" id="input-po-cene<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['po_cene'] : ''; ?>" />
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="input-po-cene-empty<?php echo $language['language_id']; ?>"><?php echo $entry_po_cene_empty; ?></label>
                        <div class="col-sm-10">
                            <input type="text" name="config_langdata[<?php echo $language['language_id']; ?>][po_cene_empty]" placeholder="<?php echo $entry_po_cene_empty; ?>" id="input-po-cene-empty<?php echo $language['language_id']; ?>" class="form-control" value="<?php echo isset($config_langdata[$language['language_id']]) ? $config_langdata[$language['language_id']]['po_cene_empty'] : ''; ?>" />
                        </div>
                    </div>
            ...
            <div class="tab-pane" id="tab-server">
              <fieldset>
                <legend><?php echo $text_general; ?></legend>
                  <div class="form-group">
                      <label class="col-sm-2 control-label" for="config_recaptcha_secret_key"><?php echo $entry_recaptcha_secret_key; ?></label>
                      <div class="col-sm-10">
                          <input type="text" name="config_recaptcha_secret_key" value="<?php echo $config_recaptcha_secret_key; ?>" id="config_recaptcha_secret_key" class="form-control"/>
                      </div>
                  </div>
                <div class="form-group">
