    ...
    <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form">
      ...
      <table id="module" class="list">
        ...
        <tbody>
		  ...
		  <tr>
            <td class="left">Use rel="alternate" hreflang="x" for product pages</td>
           	<td class="left">
				<?php if (isset($mlseo['hreflangproduct'])) { ?>
                <input type="checkbox" name="mlseo[hreflangproduct]" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="mlseo[hreflangproduct]" value="1" />
                <?php } ?></td>            
          </tr>	 
		  <tr>
            <td class="left">Use rel="alternate" hreflang="x" for category pages</td>
           	<td class="left">
				<?php if (isset($mlseo['hreflangcategory'])) { ?>
                <input type="checkbox" name="mlseo[hreflangcategory]" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="mlseo[hreflangcategory]" value="1" />
                <?php } ?></td>            
          </tr>	 
		  <tr>
            <td class="left">Use rel="alternate" hreflang="x" for brand pages</td>
           	<td class="left">
				<?php if (isset($mlseo['hreflangbrand'])) { ?>
                <input type="checkbox" name="mlseo[hreflangbrand]" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="mlseo[hreflangbrand]" value="1" />
                <?php } ?></td>            
          </tr>	 
		  <tr>
            <td class="left">Use rel="alternate" hreflang="x" for info pages</td>
           	<td class="left">
				<?php if (isset($mlseo['hreflanginfo'])) { ?>
                <input type="checkbox" name="mlseo[hreflanginfo]" value="1" checked="checked" />
                <?php } else { ?>
                <input type="checkbox" name="mlseo[hreflanginfo]" value="1" />
                <?php } ?></td>            
          </tr>	 
