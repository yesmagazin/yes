...
class ControllerSettingSetting extends Controller {
    ...
    public function index() {
        ...
        if (($this->request->server['REQUEST_METHOD'] == 'POST') && $this->validate()) {
            ...
            $this->request->post['config_meta_title_cat'] = $this->request->post['config_langdata'][$front_language_id]['meta_title_cat'];
            $this->request->post['config_meta_description_cat'] = $this->request->post['config_langdata'][$front_language_id]['meta_description_cat'];
            $this->request->post['config_meta_keyword_cat'] = $this->request->post['config_langdata'][$front_language_id]['meta_keyword_cat'];
            $this->request->post['config_meta_title_prod'] = $this->request->post['config_langdata'][$front_language_id]['meta_title_prod'];
            $this->request->post['config_meta_description_prod'] = $this->request->post['config_langdata'][$front_language_id]['meta_description_prod'];
            $this->request->post['config_meta_keyword_prod'] = $this->request->post['config_langdata'][$front_language_id]['meta_keyword_prod'];
            $this->request->post['config_po_cene'] = $this->request->post['config_langdata'][$front_language_id]['po_cene'];
            $this->request->post['config_po_cene_empty'] = $this->request->post['config_langdata'][$front_language_id]['po_cene_empty'];
        ...
        $data['entry_meta_title_prod'] = $this->language->get('entry_meta_title_prod');
        $data['entry_meta_description_prod'] = $this->language->get('entry_meta_description_prod');
        $data['entry_meta_keyword_prod'] = $this->language->get('entry_meta_keyword_prod');
        $data['entry_meta_title_cat'] = $this->language->get('entry_meta_title_cat');
        $data['entry_meta_description_cat'] = $this->language->get('entry_meta_description_cat');
        $data['entry_po_cene'] = $this->language->get('entry_po_cene');
        $data['entry_po_cene_empty'] = $this->language->get('entry_po_cene_empty');
        $data['entry_meta_keyword_cat'] = $this->language->get('entry_meta_keyword_cat');
        ...
        if (isset($this->error['meta_title_cat'])) {
            $data['error_meta_title_cat'] = $this->error['meta_title_cat'];
        } else {
            $data['error_meta_title_cat'] = '';
        }

        if (isset($this->error['meta_title_prod'])) {
            $data['error_meta_title_prod'] = $this->error['meta_title_prod'];
        } else {
            $data['error_meta_title_prod'] = '';
        }
        ...
        if (isset($this->request->post['config_meta_title_cat'])) {
            $data['config_meta_title_cat'] = $this->request->post['config_meta_title_cat'];
        } else {
            $data['config_meta_title_cat'] = $this->config->get('config_meta_title_cat');
        }

        if (isset($this->request->post['config_meta_description_cat'])) {
            $data['config_meta_description_cat'] = $this->request->post['config_meta_description_cat'];
        } else {
            $data['config_meta_description_cat'] = $this->config->get('config_meta_description_cat');
        }

        if (isset($this->request->post['config_meta_keyword_cat'])) {
            $data['config_meta_keyword_cat'] = $this->request->post['config_meta_keyword_cat'];
        } else {
            $data['config_meta_keyword_cat'] = $this->config->get('config_meta_keyword_cat');
        }

        if (isset($this->request->post['config_meta_title_prod'])) {
            $data['config_meta_title_prod'] = $this->request->post['config_meta_title_prod'];
        } else {
            $data['config_meta_title_prod'] = $this->config->get('config_meta_title_prod');
        }

        if (isset($this->request->post['config_meta_description_prod'])) {
            $data['config_meta_description_prod'] = $this->request->post['config_meta_description_prod'];
        } else {
            $data['config_meta_description_prod'] = $this->config->get('config_meta_description_prod');
        }

        if (isset($this->request->post['config_meta_keyword_prod'])) {
            $data['config_meta_keyword_prod'] = $this->request->post['config_meta_keyword_prod'];
        } else {
            $data['config_meta_keyword_prod'] = $this->config->get('config_meta_keyword_prod');
        }

        if (isset($this->request->post['config_po_cene_empty'])) {
            $data['config_po_cene_empty'] = $this->request->post['config_po_cene_empty'];
        } else {
            $data['config_po_cene_empty'] = $this->config->get('config_po_cene_empty');
        }

        if (isset($this->request->post['config_po_cene'])) {
            $data['config_po_cene'] = $this->request->post['config_po_cene'];
        } else {
            $data['config_po_cene'] = $this->config->get('config_po_cene');
        }
        ...
        if (isset($this->request->post['config_recaptcha_secret_key'])) {
            $data['config_recaptcha_secret_key'] = $this->request->post['config_recaptcha_secret_key'];
        } else {
            $data['config_recaptcha_secret_key'] = $this->config->get('config_recaptcha_secret_key');
        }
