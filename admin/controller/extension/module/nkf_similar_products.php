...
class ControllerExtensionModuleNkfSimilarProducts extends Controller {
	...
	public function index() {
        ...
        if (!empty($module_info) && isset($module_info['use_cache']) && $module_info['use_cache'])
            $data['run'] = $this->url->link('extension/module/nkf_similar_products/run', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], true);
    ...
    public function run() {
        ...
        $this->response->redirect($this->url->link('extension/module/nkf_similar_products', 'module_id='.$this->request->get['module_id'].'&token=' . $this->session->data['token'], 'SSL'));
    }
