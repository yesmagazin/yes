									...
									<div class="row footer-blocks-top">
										 <div class="col-sm-4 text-center">
											  <div class="footer-block">
												   ...
												   <div class="footer-block-content">
														...
														<h6><?php isset($_COOKIE['user_mail']) ? print($_COOKIE['user_mail']) : print($config_email);?></h6>
												   </div>
											  </div>
										 </div>
										 ...
										 <div class="col-sm-4 text-center">
											  <div class="footer-block">
												   ...
												   <div class="footer-block-content">
														<h6><?php isset($_COOKIE['user_number']) ? print($_COOKIE['user_number']) : print($config_telephone)?></h6>
										 ...
										 <div class="col-sm-4 text-center">
												<a href="index.php?route=information/information&information_id=7" class="button button-type-2">На карту!</a>
										 </div>
									</div>
								</div>
							</div>							
...
<!-- changing_contacts -->
<?php if(isset($changing_contacts)){echo $changing_contacts; } ?>
...
<noscript><div><img src="https://mc.yandex.ru/watch/53841121" style="position:absolute; left:-9999px;" alt="" /></div></noscript>
<!-- /Yandex.Metrika counter -->
</body>
</html>