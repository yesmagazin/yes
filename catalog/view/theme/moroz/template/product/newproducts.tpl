    ...
    <div class="catalog">
      <div class="catalog__row">
        ...
        <div class="catalog__container">
          ...
          <?php echo $pagination; ?>
          <!-- <div id="showmore" class="catalog__btns"><button class="catalog__btn btn btn_orange" onclick="showmore();"><span class="btn__text" style="margin: 12px 2px 12px 2px;">ПОКАЗАТЬ ЕЩЕ</span></button></div> -->
          <?php } else { ?>
