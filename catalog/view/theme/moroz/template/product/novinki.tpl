<?php echo $header; ?>
<link rel="stylesheet" type="text/css" href="catalog/view/javascript/jquery/style.css">
<div class="section">
            ...
            <div class="catalog__row">
                ...
                <div class="catalog__container">
                    ...
                    <div class="catalog__list">
                        ...
                        <div class="product-nov product<?php if (isset($product['actnew']) && !empty($product['actnew']['label'])) { 
                            echo ' actnew">';
  ...
  echo '</span></div></div>';
                            ...
                            <div class="product__inner" style="padding:0;">
                                ...
                                <?php if(FALSE && $product['stock_status']) { ?>
