...
<main class="page category">
    <section class="page__head">
        ...
        <div class="page__title"><?php echo $cat_name; ?></div>
    </section>
    <section class="page__body category">
        <div class="category__sidebar">
            <div class="category__back"></div>
            <div class="category__menu">
                <button><i class="fas fa-chevron-left"></i><?php echo $text_back; ?></button>
                <span><?php echo $text_filters; ?></span>
            </div>
        ...
        <div class="category__body">
            ...
            <div class="category__head">
                ...
                <div class="category__head-filter">
                    <button><i class="fas fa-filter"></i><?php echo $text_filters; ?></button>
                </div>
            </div>
            ...
            <div class="category__footer">
                <!--button class="category__footer-button"><?php echo $text_show_more; ?></button-->
                <?php echo $pagination; ?>
            </div>
            <?php } else { ?>
