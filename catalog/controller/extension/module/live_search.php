...
//            $liveSearchJS .= '<script src="catalog/view/javascript/live_search/live_search.js"></script><script src="https://code.jquery.com/ui/1.10.2/jquery-ui.js" ></script>'."\n";
            $liveSearchJS .= '<script src="https://code.jquery.com/ui/1.10.2/jquery-ui.js" ></script><script src="catalog/view/javascript/live_search/live_search.js" async defer></script>'."\n";
            $liveSearchJS .= '<script type="text/javascript"><!--'."\n";
			$liveSearchJS .= '$(document).ready(function() {'."\n";
///!!!
			$liveSearchJS .= 'jQuery.curCSS = function(element, prop, val) {
    return jQuery(element).css(prop, val);
};'."\n";
			$liveSearchJS .= 'var options = '.json_encode($liveSearch).';'."\n";
			$liveSearchJS .= 'setTimeout(function(){LiveSearchJs.init(options);},3000);'."\n";
			$liveSearchJS .= '});'."\n";
			$liveSearchJS .= '//--></script>'."\n";
			$liveSearchJS .= '</body>'."\n";
