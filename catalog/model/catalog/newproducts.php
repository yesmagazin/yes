<?php
class ModelCatalogNewproducts extends Model {

    private $parameter = 'p.stock_status_id';
    private $newOption = 11;
	...
	public function getNewproducts($data = array()) {
		...
		if(!empty($this->parameter) && !empty($this->newOption)) {
            $sql .= " AND {$this->parameter} = '" . (int)$this->newOption . "'";
        }
