...
class Swift_Mime_Headers_MailboxHeader extends Swift_Mime_Headers_AbstractHeader
{
    ...
    public function getFailNameAddresses()
    {
        return $this->_failmailboxes;
    }
    ...
    protected function normalizeMailboxes(array $mailboxes)
    {
        ...
        foreach ($mailboxes as $key => $value) {
            ...
            if($this->_assertValidAddress($address))
                $actualMailboxes[$address] = $name;
            else $this->_failmailboxes[] = $address;
        }
    ...
    {
        return preg_match('/^' . $this->getGrammar()->getDefinition('addr-spec') . '$/D',$address);
