            ...
            <div class="panel-body">
                <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-product" class="form-horizontal">
                    <ul class="nav nav-tabs">
                        ...
                        <li><a href="#tab-infografika" data-toggle="tab"><?php echo $tab_infografika; ?></a></li>
                    ...
                    <div class="tab-content">
                        ...
                        <div class="tab-pane" id="tab-data">
                            <div class="form-group">
                                <label class="col-sm-2 control-label" for="input-model"><?php echo $entry_video; ?></label>
                                <div class="col-sm-10">
                    ...
                    <button class="btn btn-default" type="button"><i class="fa fa-calendar"></i></button>
                        ...
                        <div class="tab-pane" id="tab-image">
                            ...
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <td class="text-left"><?php echo $entry_image_hover; ?></td>
                                    </tr>
                                    </thead>

                                    <tbody>
                                    <tr>
                                        <td class="text-left"><a href="" id="thumb-image_hover" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_hover; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="image_hover" value="<?php echo $image_hover; ?>" id="input-image_hover" /></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div class="tab-pane" id="tab-infografika">
                            <div class="table-responsive">
                                <table class="table table-striped table-bordered table-hover">
                                    <thead>
                                    <tr>
                                        <td class="text-left"><?php echo $entry_infografika; ?></td>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr>
                                        <td class="text-left"><a href="" id="thumb-infografika" data-toggle="image" class="img-thumbnail"><img src="<?php echo $thumb_inf; ?>" alt="" title="" data-placeholder="<?php echo $placeholder; ?>" /></a><input type="hidden" name="infografika" value="<?php echo $infografika; ?>" id="input-infografika" /></td>
                                    </tr>
                                    </tbody>
                                </table>
                            </div>
