...
class ControllerCommonColumnLeft extends Controller {
	public function index() {
		if (isset($this->request->get['token']) && isset($this->session->data['token']) && ($this->request->get['token'] == $this->session->data['token'])) {
			...
			if ($this->user->hasPermission('access', 'actnew/category')) {
				$actnew[] = array(
					'name'	   => $this->language->get('text_actnew_category'),
					'href'     => $this->url->link('actnew/category', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}

			if ($this->user->hasPermission('access', 'actnew/article')) {
				$actnew[] = array(
					'name'	   => $this->language->get('text_actnew_article'),
					'href'     => $this->url->link('actnew/article', 'token=' . $this->session->data['token'], true),
					'children' => array()
				);
			}
			...
			if ($actnew) {
				$data['menus'][] = array(
					'id'       => 'menu-actnew',
					'icon'	   => 'fa-newspaper-o',
					'name'	   => $this->language->get('text_actnew'),
					'href'     => '',
					'children' => $actnew
				);
			}
