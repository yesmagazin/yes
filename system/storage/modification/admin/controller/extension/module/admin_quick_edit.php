...
define('EXTENSION_STORE_URL',       'https://opencart2x.ru');
define('EXTENSION_PURCHASE_URL',    'https://opencart2x.ru');
define('EXTENSION_SUPPORT_EMAIL',   'info@opencart2x.ru');
define('EXTENSION_SUPPORT_FORUM',   'https://opencart2x.ru');
define('OTHER_EXTENSIONS',          'https://opencart2x.ru');
