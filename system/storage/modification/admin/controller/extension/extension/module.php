		...
		if ($files) {
            foreach ($files as $file) {
                ...
                if (!in_array('extension/module/' . $extension, $hiden)) {
                    ...
                    $is_ext = strpos($file,'extension/module/' . $extension);
                    ...
                    //var_dump($this->language->get('heading_title'));
                    $data['extensions'][] = array(
                        ...
                        'edit' => $this->url->link(($is_ext?'extension/':'').'module/' . $extension, 'token=' . $this->session->data['token'], true)
                    );
                }
            }
        }
