...
class ControllerCommonContentTop extends Controller {
	public function index() {
      ...
      if ($route == 'actnew/category' && isset($this->request->get['actnew_path'])) {
			$this->load->model('actnew/category');

			$path = explode('_', (string)$this->request->get['actnew_path']);

			$layout_id = $this->model_actnew_category->getCategoryLayoutId(end($path));
		}

		if ($route == 'actnew/article' && isset($this->request->get['actnew_article_id'])) {
			$this->load->model('actnew/article');

			$layout_id = $this->model_actnew_article->getArticleLayoutId($this->request->get['actnew_article_id']);
		}
